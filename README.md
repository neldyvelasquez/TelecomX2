...
-   **Clonar el repositorio** en tu entorno local o abrirlo en [Google Colab](https://colab.research.google.com/).
    git clone [https://github.com/neldyvelasquez/TelecomX2.git)
   cd TelecomX2
-   **Descargar la base de datos** y subirlo a tu entorno de [Google Colab](https://colab.research.google.com/).
